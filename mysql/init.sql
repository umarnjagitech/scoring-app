...
CREATE USER 'app_user'@'%' IDENTIFIED BY 'mysql_app_user';
GRANT SELECT, INSERT, UPDATE, DELETE ON scoring_app_db.* TO 'app_user'@'%';
FLUSH PRIVILEGES;
...
('judge1', '$2y$10$p0b3WvGg2O2s5t7u9x1y2.iA0jL1kM2n3o4p5q6r7s8t9u0v1w2x3y4z5', 'Alice Judge'),
('judge2', '$2y$10$p0b3WvGg2O2s5t7u9x1y2.iA0jL1kM2n3o4p5q6r7s8t9u0v1w2x3y4z5', 'Bob Judge');

-- Insert initial data for participants
INSERT IGNORE INTO participants (name, description) VALUES
('Participant Sudais', 'A contestant in the Quran competition.'),
('Participant Thalabah', 'A Student in the hadeeth school.'),
('Participant Safiyah', 'A Student in the fiqh school.'),
('Participant Nafisa', 'A student in the shariah school.');